...
I was looking for a project to help me learn/practice more python & I like to listen to music and scrobble to Last.fm throughout the day.  The players I use are all integrations in hass, but some only scrobbled when i was playing local tracks (vs streaming) and some had no Last.fm integration at all.  So, I decided to write my own.

On hass, I use a number of players/integrations - forked-daapd, mpd, Sonos, Plex, and Jellyfin and Spotify (played through Sonos, forked-daapd, or the Home Assistant Spotify integration).
